...
In late 2017, Hungrybox won five consecutive high level tournaments, much to the chagrin of his opponents and critics. Displeasure over his dominance led to some online discussions concerning "What should top players do to beat Hungrybox?". For context, Fox is considered to be the best character to use versus Jigglypuff, as he is generally considered to be the strongest but most technically challenging character to play. Fans in turmoil doubted Fox versus Jigglypuff and considered which alternate characters or strategies might be effective when facing Hungrybox. These discussions among fans became the subject of ridicule by Leffen, currently ranked #4 in the world, in the following tweet:  
&nbsp;  
...
Now it's time to turn back to our original win average data. Let's visualize a chart that shows the difference between the new and old win average estimates.  
...
Hbox.eb %>%
  ...
  labs(y = "Win Average", 
       ...
       subtitle = "New estimates in pink, original estimates in blue") + 
