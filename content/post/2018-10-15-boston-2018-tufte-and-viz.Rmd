...
Overall, the visualization does not look drastically different. The little changes have improved the graph's accessibility and efficiency in communicating information. This exercise reinforces how “the devil is in the detail” when designing effective data visualizations. Communicating information efficiently is a valuable skill that requires practice. Practicing simple changes that help you communicate that information will yield massive rewards.  
&nbsp;  
