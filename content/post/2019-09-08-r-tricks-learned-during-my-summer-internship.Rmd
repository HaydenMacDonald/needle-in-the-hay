...
- data joins
- R
description: "This summer, I had the pleasure of working as a Data Analyst Intern at Voices.com as a part of my MSc in Business Analytics."
---
&nbsp;  
```{r, echo=FALSE, dpi = 300}
knitr::include_graphics('/img/voices_photo.jpg', error = FALSE)
```
&nbsp;  
...
```{r, echo=FALSE, dpi = 300}
knitr::include_graphics('/img/env.png', error = FALSE)
```
