...
In this blog post, I introduce my package, `hmdrmd`, that extends `rmarkdown` by providing document templates that organize analytical thinking in data-oriented projects.  
&nbsp;
