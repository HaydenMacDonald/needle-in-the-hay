...
```
&nbsp;  
The default main font (`mainfont`) and code font (`monofont`) are set to [CMU Serif Roman](https://www.fontsquirrel.com/fonts/computer-modern){target="_blank"} and [Fira Code Medium](https://github.com/tonsky/FiraCode){target="_blank"}, respectively. Remove or change these options from the YAML header to customize your document.  
&nbsp;  
